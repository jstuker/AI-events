(function () {
  ...
  window.applyFilters = function () {
    ...
    if (btnReset) {
      btnReset.disabled = !hasActiveFilters();
    }
  ...
  function getFilteredEvents() {
    ...
    var events = [];
    document
      .querySelectorAll("#events-list .event-card")
  ...
  function renderCalendar() {
    ...
    for (var i = startOffset - 1; i >= 0; i--) {
      html +=
        '<div class="calendar-day other-month"><div class="day-number">' +
        (daysInPrevMonth - i) +
        "</div></div>";
    }
    ...
    for (var d = 1; d <= daysInMonth; d++) {
      ...
      html +=
        '<div class="calendar-day"><div class="day-number">' + d + "</div>";
