...
const EMPTY_FORM_DATA: EventFormData = {
  event_id: '', date: '', slug: '', status: 'draft', source: '', created_at: '', updated_at: '',
  contact_name: '', contact_email: '', contact_phone: '',
  event_name: '', event_description: '', event_url: '', event_start_date: '', event_end_date: '',
  event_price_type: 'free', event_price: null, event_price_currency: 'CHF',
  event_low_price: null, event_high_price: null, event_price_availability: 'InStock',
  event_image_1x1: '', event_image_16x9: '', event_language: [],
  event_attendance_mode: 'presence', event_target_audience: '',
  location_name: '', location_address: '',
  organizer_name: '', organizer_url: '',
  featured: false, featured_type: '', tags: [], publication_channels: [],
  locations: [], cities: [], organizers: [],
  body: '',
}
...
export function EventDetailPage() {
  ...
  const filePath = (location.state as { filePath?: string } | null)?.filePath ?? ''
  ...
  if (error && !event) {
    return (
      <div className="p-6">
        <Link to="/events" className="text-blue-600 hover:text-blue-800 text-sm mb-4 inline-block">&larr; Back to events</Link>
  ...
  return (
    <div className="p-6 max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <Link to="/events" className="text-blue-600 hover:text-blue-800 text-sm">&larr; Back to events</Link>
          <h1 className="text-2xl font-bold text-gray-900 mt-1">{event.event_name}</h1>
        </div>
