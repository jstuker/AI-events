...
describe('EventDetailView', () => {
  ...
  it('renders location info', () => {
    const event = createEvent({ location_name: 'Zurich', location_address: 'Bahnhofstrasse 1' })
    render(<EventDetailView event={event} />)
  ...
  it('renders organizer info', () => {
    const event = createEvent({ organizer_name: 'SwissAI', organizer_url: 'https://swissai.ch' })
    render(<EventDetailView event={event} />)
  ...
  it('renders pricing for paid event', () => {
    const event = createEvent({ event_price_type: 'paid', event_price: 50, event_price_currency: 'CHF' })
    render(<EventDetailView event={event} />)
