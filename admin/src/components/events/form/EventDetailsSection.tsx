  ...
  return (
    <fieldset className="space-y-4">
      ...
      <div>
        ...
        />
        {errors.event_name && (
          <p className="mt-1 text-xs text-red-600">{errors.event_name}</p>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          />
          {errors.event_url && (
            <p className="mt-1 text-xs text-red-600">{errors.event_url}</p>
          )}
        </div>
      </div>
